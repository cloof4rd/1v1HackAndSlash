...
public class Player1Script : MonoBehaviour, IDamageable
{
    public KeyCode meleeAttackKey = KeyCode.Q; // Q for melee attack
    public KeyCode jumpKey = KeyCode.Space;    // Space for jump
    public string xMoveAxis = "Horizontal";    // WASD movement
